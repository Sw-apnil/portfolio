...
const projects = [
    {
        ...
        systemLine:
            "A full-stack movie ticket booking system with browsing, seat selection, and payment processing.",
        bullets: [
        ...
        github: "https://github.com/Sw-apnil/bookshowapi",
        live: "https://bookshowui.vercel.app",
        image: "/quickshow.png",
    },
    {
        title: "Splitr",
        subtitle: "Expense Splitting Platform",
        systemLine:
            "A real-time group expense tracker with automated settlement calculations and spending analytics.",
        bullets: [
            "Built group expense tracking with shared balances and settlements",
            "Implemented greedy-based debt minimization to compute optimal settlement transactions",
            "Developed APIs for expense creation, updates, and transaction history",
            "Used greedy approach with sorted balances to minimize settlement transactions",
        ],
        tech: ["Next.js", "React.js", "Convex", "Google Gemini AI", "Clerk"],
        github: "https://github.com/Sw-apnil/Splitwise",
        live: "https://splitr-q9gg.vercel.app",
        image: "/splitr.png",
    },
    {
        title: "QuickChat",
        ...
        systemLine:
            "A full-stack messaging platform with instant communication, presence tracking, and media sharing.",
        bullets: [
        ...
        github: "https://github.com/Sw-apnil/Quickchatui",
        live: "https://quickchat-inky-rho.vercel.app",
        image: "/quickchat.png",
    },
    {
        title: "MenuEngine",
        subtitle: "Menu & Services Management Backend",
        systemLine:
            "A backend system for managing restaurant menus, dynamic pricing, tax inheritance, and booking workflows.",
        bullets: [
            "Designed backend system with hierarchical data modeling for categories, subcategories, and items",
            "Implemented pricing engine supporting multiple pricing types, tax inheritance, and validation rules",
            "Built APIs for availability, booking workflows, and add-on based dynamic price calculation",
        ],
        tech: ["Node.js", "Express.js", "MongoDB"],
        github: "https://github.com/Sw-apnil/guestara-backend",
        live: "",
        image: "/menuengine.png",
    },
];
