...
const socials = [
    {
        name: "Email",
        value: "swapnil414416@gmail.com",
        href: "mailto:swapnil414416@gmail.com",
        icon: Mail,
        color: "text-red-500",
        bg: "bg-red-500/10",
    ...
    {
        name: "LinkedIn",
        value: "swapnil-saurabh",
        href: "https://linkedin.com/in/swapnil-saurabh",
        icon: Linkedin,
        color: "text-blue-600",
        bg: "bg-blue-500/10",
    ...
    {
        name: "Twitter",
        value: "@saurabh_swapnil",
        href: "https://twitter.com/saurabh_swapnil",
        icon: Twitter,
        color: "text-sky-500",
        bg: "bg-sky-500/10",
                            ...
                            <div className="grid gap-3 flex-grow">
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-text-secondary text-[13px]">Ranchi, India</p>
                                    </div>
                                </motion.div>
                            </div>
                        </motion.div>
